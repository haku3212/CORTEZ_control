...
export function registerIpcHandlers(ipcMain: IpcMain, app: App): void {
  const handlers: Record<string, Handler> = {
    ...
    'retiros:list': () => listRetirosEmpresa(),
    'retiros:create': (payload) => createRetiroEmpresa(asRecord(payload)),
    ...
    'precios:list': () => listPreciosCategoria(),
    'precios:update': (payload) => updatePrecioCategoria(asRecord(payload)),
